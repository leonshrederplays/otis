...
module.exports.run = async (bot, message, args) => {
    ...
    .setAuthor(`Otis`, bot.user.avatarURL)
    ...
    let membed = new discord.RichEmbed()
        .setColor('RANDOM')
        .setThumbnail(bot.user.avatarURL)
        .setTitle(`-=- Help Music -=- <>: MUST, []: OPTIONAL  || ALPHA`)
